...
\begin{figure}[h]
    ...
    \caption{Training loss curve for the character-level Shakespeare language model: average loss versus number of epochs (sampled every \texttt{plot\_every} steps).}
