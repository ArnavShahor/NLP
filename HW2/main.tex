...
The bi-gram perplexity is computed in \texttt{q1\_2\_3/q3b\_perplexity.py} (loads \texttt{saved\_params\_40000.npy} and calls \texttt{eval\_neural\_lm} on the POS-tagged passages). The character-level RNN perplexity is computed by an added cell in \texttt{q2\_char\_rnn\_generation.ipynb}.
